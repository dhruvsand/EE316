...
ISEStep( "vivado",
         "-log flight_attendant_call_system_dataflow.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source flight_attendant_call_system_dataflow.tcl" );
