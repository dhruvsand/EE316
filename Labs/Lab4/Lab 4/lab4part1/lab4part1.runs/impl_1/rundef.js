...
ISEStep( "vivado",
         "-log flight_attendant_call_system_dataflow.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source flight_attendant_call_system_dataflow.tcl -notrace" );
