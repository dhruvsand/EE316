...
HD_PWD='C:/Users/Dhruv Sandesara/Desktop/ee316/Labs/Lab4_Part1/Lab4_Part1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log flight_attendant_call_system_dataflow.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source flight_attendant_call_system_dataflow.tcl
