...
HD_PWD='C:/Users/Dhruv Sandesara/Desktop/ee316/Labs/Lab4_Part1/Lab4_Part1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log flight_attendant_call_system_dataflow.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source flight_attendant_call_system_dataflow.tcl -notrace
