...
HD_PWD='C:/Users/Dhruv Sandesara/Desktop/ee316/Labs/Lab_2/Lab_2.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Decoder_structural.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Decoder_structural.tcl
