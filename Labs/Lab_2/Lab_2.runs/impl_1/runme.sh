...
HD_PWD='C:/Users/Dhruv Sandesara/Desktop/ee316/Labs/Lab_2/Lab_2.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Decoder_structural.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Decoder_structural.tcl -notrace
