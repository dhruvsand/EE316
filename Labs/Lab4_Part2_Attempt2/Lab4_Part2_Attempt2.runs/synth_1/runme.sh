...
HD_PWD='C:/Users/Dhruv Sandesara/Desktop/ee316/Labs/Lab4_Part2_Attempt2/Lab4_Part2_Attempt2.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log rising_edge_detector.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source rising_edge_detector.tcl
